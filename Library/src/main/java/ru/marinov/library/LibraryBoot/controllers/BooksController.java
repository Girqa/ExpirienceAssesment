...
import ru.marinov.library.LibraryBoot.dao.BookDAO;
import ru.marinov.library.LibraryBoot.dao.PersonDAO;
...
public class BooksController {
    ...
    public String show(@PathVariable("id") int id,
        ...
        if (book.isPresent()){
            ...
            Optional<Person> owner = booksService.getBookOwner(book.get());
            if (owner.isPresent()) {
